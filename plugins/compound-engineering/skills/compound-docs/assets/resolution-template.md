...
component: [data_model|api_handler|view_template|service_object|background_job|database|frontend_component|frontend_framework|email_processing|assistant|authentication|payments]
symptoms:
  - [Observable symptom 1 - specific error message or behavior]
  - [Observable symptom 2 - what user actually saw/experienced]
root_cause: [missing_relation|missing_eager_load|missing_index|wrong_api|scope_issue|thread_violation|async_timing|memory_leak|config_error|logic_error|test_isolation|missing_validation|missing_permission]
framework_version: [14.2.0 - optional]
...
- Framework Version: [e.g., 14.2.0]
- Affected Component: [e.g., "Email Processing model", "Authentication handler", "Payments service"]
