...
**component values:**
- data_model, api_handler, view_template, service_object
- background_job, database, frontend_component, frontend_framework
...
**root_cause values:**
- missing_relation, missing_eager_load, missing_index, wrong_api
