...
user: "I need to implement file uploads using UploadThing"
assistant: "I'll use the framework-docs-researcher agent to gather comprehensive documentation about UploadThing"
...
user: "Why is the @tanstack/react-query package not working as expected?"
assistant: "Let me use the framework-docs-researcher agent to investigate the @tanstack/react-query documentation and source code"
...
4. **Source Code Analysis**:
   - Use package manager commands like `pnpm ls <package_name>` to locate installed packages
...
1. **Initial Assessment**:
   ...
   - Determine the installed version from `package.json` and lockfiles (`package-lock.json`, `pnpm-lock.yaml`, or `yarn.lock`)
...
4. **Source Exploration**:
   - Use package manager and filesystem paths to find package locations (for example, `node_modules/<package_name>`)
